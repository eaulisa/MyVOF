    subroutine get_matrix2( ver,ps,at,bt )
    !-------------------------------------------subroutine  comment
    ...
    real,intent(out) :: at(1:6,1:6),bt(1:6)
    ...
    at(2, 1) = at(1,2)
    at(2, 2) = ver(1,1)**2+ver(2,1)**2+ver(3,1)**2+ver(4,1)**2+ver(5,1)**2+ver(6,1)**2+ver(7,1)**2+ver(8,1)**2+ver(9,1)**2
    ...
    at(3, 1) = at(1,3)
    at(3, 2) = at(2,3) 
    at(3, 3) = ver(1,2)**2+ver(2,2)**2+ver(3,2)**2+ver(4,2)**2+ver(5,2)**2+ver(6,2)**2+ver(7,2)**2+ver(8,2)**2+ver(9,2)**2
    ...
    at(4, 2) = at(2,4)
    at(4, 3) = at(3,4)
    at(4, 4) = ver(1,3)**2+ver(2,3)**2+ver(3,3)**2+ver(4,3)**2+ver(5,3)**2+ver(6,3)**2+ver(7,3)**2+ver(8,3)**2+ver(9,3)**2
    ...
    at(5, 3) = at(3,5)
    at(5, 4) = at(4,5)
    at(5, 5) = ver(1,4)**2+ver(2,4)**2+ver(3,4)**2+ver(4,4)**2+ver(5,4)**2+ver(6,4)**2+ver(7,4)**2+ver(8,4)**2+ver(9,4)**2
    ...
    at(6, 4) = at(4,6)
    at(6, 5) = at(5,6)
    at(6, 6) = ver(1,5)**2+ver(2,5)**2+ver(3,5)**2+ver(4,5)**2+ver(5,5)**2+ver(6,5)**2+ver(7,5)**2+ver(8,5)**2+ver(9,5)**2
